                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-md-offset-2">
                            ...
                            <div class="post login-form">
                                <form action="functions/login.php" class="form newtopic" id="login" method="post">
                                    ...
                                    <div class="postinfobot">
                                        ...
                                        <div class=" postreply">
                                            ...
                                            <div class="pull-left"><button type="submit" class="btn btn-primary" name="login">Login</button></div>
                                            <div class="clearfix"></div>
                                        </div>
